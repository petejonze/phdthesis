...
%\documentclass[oneside, logo, abbrevs, a4paper, listsintoc, parskip, 12pt]{phdthesis} % example viva version
\documentclass[twoside, logo, abbrevs, a4paper, listsintoc, parskip, singlespace, 11pt]{phdthesis} % example final submission version
